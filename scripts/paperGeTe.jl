...
plot(plot(dfbandsnsoc[11:19],tbbandsf,title="No SOC",label="",fermi=9.2879,xticks=([0,101,201],["A","Z","U"]),subplot_index=1,ylim=[-13,9]),plot(dfbands[21:37],tbbandssocf,title="SOC",yl="",fermi=9.2879,xticks=([0,101,201],["A","Z","U"]),subplot_index=2,ylim=[-13,9],leg=false),plot(dfbands[21:37],tbbandssocf,title="SOC",yl="",fermi=9.2879,xticks=([0,101,201],["A","Z","U"]),subplot_index=3,ylim=[-5,5]),titlefont = font(30,"Courier"),size=(1800,600),layout=(1,3))
#-----------plot heatmaps-----------------
begin
  T=Float64
  dfbandssoc = read_bands_file("/Users/ponet/Documents/Fysica/PhD/GeTe/fullrel/GeTe_bands.out",T);
...
dfbands = read_bands_file("/Users/ponet/Documents/Fysica/PhD/GeTe/colin/p_0.0/bands.out",Float64);
plotlyjs()
dfbandssoc = read_bands_file("/Users/ponet/Documents/Fysica/PhD/GeTe/fullrel/GeTe_bands.out");
