...
atomic_positions = get_data(BiTeI_nsoc,"vc",:atomic_positions)
Te_pos = atomic_positions[:Te]
I_pos  = atomic_positions[]
atomic_positions[:Te] = I_pos
atomic_positions[:I] = Te_pos
atomic_positions[:I] = [Point3D{Float32}(1/3,2/3,0.3194)]
atomic_positions[:Te] = [Point3D{Float32}(2/3,1/3,0.7363)]
